...
data class TimePlannerIcons(
    ...
    val categoryCustomIconRocket: Int,
    val categoryCustomIconPets: Int,
    val categoryCustomIconCall: Int,
    val categoryCustomIconMeditate: Int,
    val categoryCustomIconGroup: Int,
    val categoryCustomIconCode: Int,
    val categoryCustomIconGrowth: Int,
    val categoryCustomIconEvent: Int,
    val categoryCustomIconBook: Int,
    val categoryCustomIconUser: Int,
    val categoryCustomIconHiking: Int,
    val categoryCustomIconArt: Int,
    val categoryCustomIconMusic: Int,
    val arrowUp: Int,
    val arrowDown: Int,
...
internal val baseTimePlannerIcons = TimePlannerIcons(
    ...
    categoryCustomIconRocket = R.drawable.ic_rocket,
    categoryCustomIconPets = R.drawable.ic_pets,
    categoryCustomIconCall = R.drawable.ic_call,
    categoryCustomIconMeditate = R.drawable.ic_meditate,
    categoryCustomIconGroup = R.drawable.ic_group,
    categoryCustomIconCode = R.drawable.ic_code,
    categoryCustomIconGrowth = R.drawable.ic_growth,
    categoryCustomIconEvent = R.drawable.ic_event,
    categoryCustomIconBook = R.drawable.ic_book,
    categoryCustomIconUser = R.drawable.ic_user,
    categoryCustomIconHiking = R.drawable.ic_hiking,
    categoryCustomIconArt = R.drawable.ic_art,
    categoryCustomIconMusic = R.drawable.ic_music,
